            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-12">
                        ...
                        <div class="logo">
                            <a href="{{ route('home') }}" class="fw-bold fs-4 ">Market<span
                                    class="fs-1 fw-bold  color">Pulse</span></a>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-7 col-12">
                                    <div class="hero-text">
                                        ...
                                        <p>Maboriosam in a nesciung eget magnae <br> dapibus disting tloctio in the
                                            find
                                                ...
                                                <div class="product-img">
                                                    <a href="product-details.html">
                                                        <img class="default-img"
                                                            ...
                                                            alt="#">
                                                        <img class="hover-img"
                                                            src="https://wpthemesgrid.com/themes/free/eshop/images/products/p2.jpg"
                                                            alt="#">
                                                    </a>
                                                    <div class="button-head">
                                                        <div class="product-action">
                                                            ...
                                                            <a title="Wishlist" href="#"><i
                                                                    class="fa-solid fa-heart"></i><span>Add to
                                                                    Wishlist</span></a>
                                                            <a title="Wishlist" href="#"><i
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                ...
                                                <div class="product-content">
                                                    <h3><a href="product-details.html">Polo Dress For Women</a>
                                                    </h3>
                                                    <div class="product-price">
                                                        <span>$29.00</span>
                                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                            <div class="single-product">
                                                ...
                                                <div class="product-content">
                                                    <h3><a href="product-details.html">Black Sunglass For
                                                            Women</a></h3>
                                                    <div class="product-price">
                                                        <span class="old">$60.00</span>
                                                        <span>$50.00</span>
                ...
                <div class="modal-body">
                    <div class="row no-gutters">
                        <div class="col-lg-6 offset-lg-3 col-12">
                            <h4
                                style="margin-top:100px;font-size:14px; font-weight:500; color:#F7941D; display:block; margin-bottom:12px;">
                                Eshop Free Lite</h4>
                            <h3 style="font-size:30px;color:#333;">Currently You are using free lite Version of
                                Eshop.
                                <h3>
                                    <p
                            ...
                            <div class="contact">
                                <ul>
                                    ...
                                    <li><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                            data-cfemail="8ce5e2eae3cce9ffe4e3fca2efe3e1">[email&#160;protected]</a>
                                    </li>
                                    <li>+032 3456 7890</li>
                                </ul>
                            </div>
